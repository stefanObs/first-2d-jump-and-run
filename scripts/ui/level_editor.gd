...
func _type_color(type_name: String) -> Color:
	var colors := {
		...
		"spring": Color(0.3, 0.9, 0.45),
		"ladder": Color(0.62, 0.42, 0.22),
		"conveyor": Color(0.55, 0.45, 0.28),
		"timed_door": Color(0.7, 0.35, 0.18),
		"fence": Color(0.58, 0.4, 0.22),
		"mover": Color(0.7, 0.5, 0.28),
		"moving_cloud": Color(0.75, 0.82, 0.95),
		"blink_cloud": Color(0.7, 0.75, 0.9),
		"wind": Color(0.45, 0.75, 0.95),
		"bandit": Color(0.32, 0.18, 0.08), "bounty_bandit": Color(0.75, 0.12, 0.08),
		"bull": Color(0.55, 0.28, 0.1),
		"ninja": Color(0.28, 0.22, 0.42),
		"rattlesnake": Color(0.55, 0.4, 0.15),
		"scorpion": Color(0.62, 0.32, 0.12),
		"carrion": Color(0.45, 0.35, 0.55),
		"bat": Color(0.45, 0.32, 0.55),
		"acid_drip": Color(0.95, 0.35, 0.75),
		"stalactite": Color(0.55, 0.6, 0.75),
		"stalactite_static": Color(0.45, 0.5, 0.65),
