...
- **Last completed step:** Bull charges toward player after stun; sunset rider frames size-matched
...
- **Tests last run:** all automated tests passed after bull aim + rider scale fix
