...
**Content version:** `1.8.65` (see `content_version.txt`). Launchers reimport when this stamp changes.
...
9. Moonlight Gulch — Speed Stars + earlier tricks; the raised final plank is optional, with no forced spring and enough clearance to continue underneath without flying
