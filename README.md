...
- **Trail bulls:** reuse stampede-bull art scaled to bandit height; charge the player when nearby; lasso or head stomp ties once (pass-through); side contact hurts; **stop at plank edges** (won't run off the trail).
