...
**Content version:** `1.8.16` (see `content_version.txt`). Launchers reimport when this stamp changes.
...
- Cave floors use dense cool stone + pink flecks; **higher** curved rock ceiling with **sparse embedded stalactites**; deep cave wash / **sky wash touches the floor**; no desert sun/mesa hills.
