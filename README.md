...
- **Last completed step:** Camp rollback now restores tied bandits and active bonuses with at least 20 seconds
...
- **Tests last run:** all automated tests passed after camp-state rollback and persistence changes
