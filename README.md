...
| Level 15 | Cave Dragon | Fly L↔R under ceiling spitting straight flameballs (2×2), land for lasso; repeat; 3rd lasso ties the mouth |
...
- Cave floors use dense cool stone + pink flecks; cowboy-style rock ceiling **segments** with **varied lip heights** and seat notches for teeth; solid fill stays **above** the segment tops (never shows through below the painted underside); sparse décor stalactites attach only on those seats (none on Dragon Gate / Cave Dragon); deep cave wash **tucks under the floor** (no gap); no desert sun/mesa hills.
